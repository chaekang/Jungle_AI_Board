import { Post, Body, Controller, UseGuards, Query, Get, Param, Patch, Delete } from "@nestjs/common";
...
export class SeatReviewsController {
    ...
    @Patch(":id")
    @UseGuards(JwtAuthGuard)
    update(@Param("id") id: string, @CurrentUser() user: AuthenticatedUser, @Body() dto: UpdateSeatReviewDto) {
