        ...
        input: [
          {
            ...
            content: [
              ...
              '작품 줄거리, 원작, 작가, 역사 같은 일반 작품 지식은 말하지 않는다. 제공된 좌석 후기 근거에 있는 내용만 사용한다.',
              ...
              '"후기를 참고하면", "후기에서는", "평가를 받고 있다"처럼 조사 과정을 설명하지 말고 바로 결론을 말한다.',
              '"~라고 평가된다", "~라는 언급이 있다", "~라는 후기가 있다"처럼 다른 사람의 의견 형태로 돌려 말하지 않는다.',
              '"이 자리는 ...해요. 다만 ...해요."처럼 상담자가 확인한 결론으로 말한다.',
              '같은 내용을 반복하지 않고 2~4문장의 단일 문단으로 답한다.',
              '답변은 한국어로 작성한다.',
              '친절하지만 과장하지 말고, 사용자의 질문에 직접 답한다.',
            ].join('\n'),
          },
          {
            role: 'user',
